        ...
        function r(r) {
            (r && 3 === r.which) ||
                ...
                t(a).each(function () {
                    ...
                    n.hasClass("open") &&
                        ((r && "click" == r.type && /input|textarea/i.test(r.target.tagName) && t.contains(n[0], r.target)) ||
                            (n.trigger((r = t.Event("hide.bs.dropdown", a))), r.isDefaultPrevented() || (o.attr("aria-expanded", "false"), n.removeClass("open").trigger(t.Event("hidden.bs.dropdown", a)))));
                }));
        }
        function o(e) {
