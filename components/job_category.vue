  ...
  <div class="section margin-top-60 margin-bottom-60">
        <div class="container">
          <div class="row">
            <div class="col-xl-12">
              <div
                class="utf-section-headline-item centered margin-top-0 margin-bottom-40"
              >
              ...
              <div class="utf-categories-container-block">
                <a
                  ...
                  class="utf-category-box"
                >
                  <div class="utf-opening-position-counter-item">
                    10 Openings
                  </div>
                ...
                >
                  ...
                  <div class="utf-category-box-icon-item">
                    <i class="icon-line-awesome-line-chart"></i>
                  </div>
                  <div class="utf-category-box-content">
                ...
                >
                  ...
                  <div class="utf-category-box-icon-item">
                    <i class="icon-line-awesome-user-md"></i>
                  </div>
                  <div class="utf-category-box-content">
                    <h3>Health</h3>
                  </div>
              ...
              <div class="utf-centered-button margin-top-10">
                <a
                  href="jobs-categorie-one.html"
                  class="button utf-ripple-effect-dark utf-button-sliding-icon margin-top-20"
                  >View All Categories <i class="icon-feather-chevron-right"></i
                ></a>
              </div>
            </div>
          </div>
