          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <p class="utf-trending-silver-item">
                <span class="utf-trending-black-item"
                  >Trending Jobs Keywords:</span
                >
            ...
            <div class="col-md-12">
              <ul class="intro-stats margin-top-45 hide-under-992px">
                <li>
                  ...
                  <sub class="counter_item"
                    ><strong class="counter">18,955</strong>
                    <span>Live Jobs Posted</span></sub
                  >
                </li>
                <li>
                  <i class="icon-material-outline-assignment"></i>
                  <sub class="counter_item"
                    ><strong class="counter">11,088</strong>
                    <span>Jobs Candidate</span></sub
                  >
                </li>
                <li>
                  <i class="icon-material-outline-library-books"></i>
                  <sub class="counter_item"
                    ><strong class="counter">10,758</strong>
                    <span>Companies Jobs</span></sub
                  >
                </li>
              </ul>
            </div>
